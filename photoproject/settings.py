...
# お使いのものを入力してください
DEFAULT_FROM_EMAIL = '0hara.2372012ishii@gmail.com'  # メールの送信元のアドレスを入力
EMAIL_HOST = 'smtp.gmail.com'            # GmailのSMPTサーバー　　　
EMAIL_PORT = 587                         # SMPTサーバーのポート番号
EMAIL_HOST_USER = '0hara.2373012ishii@gmail.com'     # Gmailのアドレスを入力
EMAIL_HOST_PASSWORD = 'cicdudysgoilthrf' # Gmailのアプリ用パスワードを入力
